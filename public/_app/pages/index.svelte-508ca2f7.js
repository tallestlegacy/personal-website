import{S as A,i as L,s as x,e as g,c as f,a as y,d,b as i,J as F,f as N,H as h,I as _,t as D,k,g as S,n as T,K as W,j as O,m as H,o as M,x as V,u as G,v as Q}from"../chunks/vendor-a6a187a6.js";var j="/_app/assets/tl logo-836f42e7.svg";function C(v){let e,n,t,c;return{c(){e=g("div"),n=g("div"),t=g("img"),this.h()},l(s){e=f(s,"DIV",{class:!0});var m=y(e);n=f(m,"DIV",{class:!0});var p=y(n);t=f(p,"IMG",{id:!0,src:!0,alt:!0,srcset:!0,class:!0}),p.forEach(d),m.forEach(d),this.h()},h(){i(t,"id","logo"),F(t.src,c=j)||i(t,"src",c),i(t,"alt",""),i(t,"srcset",""),i(t,"class","svelte-101hwf0"),i(n,"class","logo-container svelte-101hwf0"),i(e,"class","checkered svelte-101hwf0")},m(s,m){N(s,e,m),h(e,n),h(n,t)},p:_,i:_,o:_,d(s){s&&d(e)}}}class z extends A{constructor(e){super();L(this,e,null,C,x,{})}}function R(v,e,n){const t=v.slice();return t[1]=e[n],t}function q(v){let e,n=v[1]+"";return{c(){e=g("div"),this.h()},l(t){e=f(t,"DIV",{class:!0});var c=y(e);c.forEach(d),this.h()},h(){i(e,"class","verse")},m(t,c){N(t,e,c),e.innerHTML=n},p:_,d(t){t&&d(e)}}}function J(v){let e,n,t,c,s,m,p,l=v[0],a=[];for(let o=0;o<l.length;o+=1)a[o]=q(R(v,l,o));return{c(){e=g("main"),n=g("h3"),t=D("The Raven"),c=k(),s=g("h3"),m=D("by Edgar Allen Poe"),p=k();for(let o=0;o<a.length;o+=1)a[o].c();this.h()},l(o){e=f(o,"MAIN",{class:!0});var u=y(e);n=f(u,"H3",{});var r=y(n);t=S(r,"The Raven"),r.forEach(d),c=T(u),s=f(u,"H3",{});var w=y(s);m=S(w,"by Edgar Allen Poe"),w.forEach(d),p=T(u);for(let b=0;b<a.length;b+=1)a[b].l(u);u.forEach(d),this.h()},h(){i(e,"class","svelte-1anzup2")},m(o,u){N(o,e,u),h(e,n),h(n,t),h(e,c),h(e,s),h(s,m),h(e,p);for(let r=0;r<a.length;r+=1)a[r].m(e,null)},p(o,[u]){if(u&1){l=o[0];let r;for(r=0;r<l.length;r+=1){const w=R(o,l,r);a[r]?a[r].p(w,u):(a[r]=q(w),a[r].c(),a[r].m(e,null))}for(;r<a.length;r+=1)a[r].d(1);a.length=l.length}},i:_,o:_,d(o){o&&d(e),W(a,o)}}}function K(v){return[[`Once upon a midnight dreary, while I pondered weak and weary,
...
<br>Only this, and nothing more.'`,`Ah, distinctly I remember it was in the bleak December,
...
<br>Nameless here for evermore.`,`And the silken sad uncertain rustling of each purple curtain
...
<br>This it is, and nothing more,'`,`Presently my soul grew stronger; hesitating then no longer,
...
<br>Darkness there, and nothing more."`,`Deep into that darkness peering, long I stood there wondering, fearing,
...
<br>Merely this and nothing more.`,`Back into the chamber turning, all my soul within me burning,
...
<br>'Tis the wind and nothing more!'`,`Open here I flung the shutter, when, with many a flirt and flutter,
...
<br>Perched, and sat, and nothing more.`,`Then this ebony bird beguiling my sad fancy into smiling,
...
<br>Quoth the raven, 'Nevermore.'`,`Much I marvelled this ungainly fowl to hear discourse so plainly,
...
<br>With such name as 'Nevermore.'`,`But the raven, sitting lonely on the placid bust, spoke only,
...
<br>Then the bird said, 'Nevermore.'`,`Startled at the stillness broken by reply so aptly spoken,
...
<br>Of "Never-nevermore."'`,`But the raven still beguiling all my sad soul into smiling,
...
<br>Meant in croaking 'Nevermore.'`,`This I sat engaged in guessing, but no syllable expressing
...
<br>She shall press, ah, nevermore!`,`Then, methought, the air grew denser, perfumed from an unseen censer
...
<br>Quoth the raven, 'Nevermore.'`,`'Prophet!' said I, 'thing of evil! - prophet still, if bird or devil! -
...
<br>Quoth the raven, 'Nevermore.'`,`'Be that word our sign of parting, bird or fiend!' I shrieked upstarting -
...
<br>Quoth the raven, 'Nevermore.'`,`And the raven, never flitting, still is sitting, still is sitting
...
<br>Shall be lifted - nevermore!`]]}class U extends A{constructor(e){super();L(this,e,K,J,x,{})}}function X(v){let e,n,t,c,s,m,p,l,a,o,u,r,w;return t=new z({}),r=new U({}),{c(){e=g("main"),n=g("div"),O(t.$$.fragment),c=k(),s=g("div"),m=g("div"),p=k(),l=g("div"),a=g("h1"),o=D("Tallest Legacy"),u=k(),O(r.$$.fragment),this.h()},l(b){e=f(b,"MAIN",{class:!0});var I=y(e);n=f(I,"DIV",{class:!0});var B=y(n);H(t.$$.fragment,B),B.forEach(d),c=T(I),s=f(I,"DIV",{class:!0});var $=y(s);m=f($,"DIV",{class:!0,id:!0}),y(m).forEach(d),p=T($),l=f($,"DIV",{id:!0,class:!0});var E=y(l);a=f(E,"H1",{class:!0});var P=y(a);o=S(P,"Tallest Legacy"),P.forEach(d),u=T(E),H(r.$$.fragment,E),E.forEach(d),$.forEach(d),I.forEach(d),this.h()},h(){i(n,"class","hero svelte-17n6muh"),i(m,"class","checkered svelte-17n6muh"),i(m,"id","background"),i(a,"class","svelte-17n6muh"),i(l,"id","foreground"),i(l,"class","svelte-17n6muh"),i(s,"class","content svelte-17n6muh"),i(e,"class","svelte-17n6muh")},m(b,I){N(b,e,I),h(e,n),M(t,n,null),h(e,c),h(e,s),h(s,m),h(s,p),h(s,l),h(l,a),h(a,o),h(l,u),M(r,l,null),w=!0},p:_,i(b){w||(V(t.$$.fragment,b),V(r.$$.fragment,b),w=!0)},o(b){G(t.$$.fragment,b),G(r.$$.fragment,b),w=!1},d(b){b&&d(e),Q(t),Q(r)}}}class Z extends A{constructor(e){super();L(this,e,null,X,x,{})}}export{Z as default};
